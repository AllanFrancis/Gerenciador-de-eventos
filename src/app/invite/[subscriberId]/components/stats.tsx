  ...
  return (
    <div className="grid md:grid-cols-3 gap-3">
      <div className="relative rounded-xl bg-gray-700 border border-gray-600 px-4 py-7 flex flex-col items-center justify-center gap-1">
        ...
        <MousePointerClickIcon className="size-5 text-purple top-3 left-3 absolute" />
      </div>
      ...
      <div className="relative rounded-xl bg-gray-700 border border-gray-600 px-4 py-7 flex flex-col items-center justify-center gap-1">
        ...
        <BadgeCheckIcon className="size-5 text-purple top-3 left-3 absolute" />
      </div>
      ...
      <div className="relative rounded-xl bg-gray-700 border border-gray-600 px-4 py-7 flex flex-col items-center justify-center gap-1">
        ...
        <MedalIcon className="size-5 text-purple top-3 left-3 absolute" />
      </div>
    </div>
  )
}
